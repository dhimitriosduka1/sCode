        ...
        try {
            ...
            if (!isAvailable) {
                ...
                if (this.slurmService.isRemoteMode()) {
                    items.push(new LeaderboardMessageItem(`SSH connection failed or SLURM not available on '${this.slurmService.getRemoteHost()}'`, 'warning'));
                    ...
                    items.push(new LeaderboardMessageItem('SLURM not available on this system', 'warning'));
                }
                return items;
            }
